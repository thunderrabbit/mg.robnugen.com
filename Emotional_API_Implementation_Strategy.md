...
CREATE TABLE mifmus (
    ...
    UNIQUE KEY uniq_key_myid (key_id, my_id),
...
CREATE TABLE interaction_sessions (
    ...
    KEY idx_key_recent (key_id, last_event_time),
    FOREIGN KEY (key_id) REFERENCES api_keys(key_id) ON DELETE CASCADE,
...
CREATE TABLE interaction_events (
    ...
    key_id            BIGINT UNSIGNED NOT NULL,
    user_id           INT UNSIGNED NOT NULL,
    mifmus_id         BIGINT UNSIGNED NULL,       -- NULL if event has no state tag
...
3. If not found:
     INSERT INTO interaction_sessions (key_id, user_id) VALUES (:key_id, :user_id)
     Use new session_id
```

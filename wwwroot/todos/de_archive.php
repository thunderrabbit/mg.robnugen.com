...
// Verify ownership and restore
$success = $todoHelper->deArchiveTodo($todo_id, $user_id);
...
if ($success) {
    header("Location: /todos/?msg=todo_restored");
    exit;
} else {
    header("Location: /todos/?msg=restore_failed");
    exit;
}
